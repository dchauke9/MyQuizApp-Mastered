...
public class MathsQuizActivity extends AppCompatActivity {
    private static final String LOG_TAG = MathsQuizActivity.class.getSimpleName();
    // Question 1
    ...
    public void submitAnswers(View view) {
        ...
        if (answer6.equals("9") || answer6.equals("nine")) {
            answer6_score = 1;
        } else {
            answer6_score = 0;
        }
        ...
        //------------------------------------------------------------------------------------------
        Boolean answer9;
        question9_choice1 = (RadioButton) this.findViewById(R.id.question9_choice2);
