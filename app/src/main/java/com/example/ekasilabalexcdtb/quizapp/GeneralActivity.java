...
public class GeneralActivity extends AppCompatActivity {
    ...
    public void submitAnswers(View view) {
        ...
        question1_choice2 = (RadioButton) this.findViewById(R.id.questionGen1_choice2);
        ...
        //------------------------------------------------------------------------------------------
        String answer2;
        question2_answer = (EditText) this.findViewById(R.id.questionGen2_answer);
        answer2 = question2_answer.getText().toString().toLowerCase();
        if (answer2.equals("jacob zuma")) {
            answer2_score = 1;
        } else {
            answer2_score = 0;
        }
        ...
        question3_choice1 = (CheckBox) this.findViewById(R.id.questionGen3_choice1);
        question2_choice2 = (CheckBox) this.findViewById(R.id.questionGen3_choice2);
        question3_choice3 = (CheckBox) this.findViewById(R.id.questionGen3_choice3);
        question3_choice4 = (CheckBox) this.findViewById(R.id.questionGen3_choice4);
        ...
        //------------------------------------------------------------------------------------------
        String answer4;
        question4_answer = (EditText) this.findViewById(R.id.questionGen4_answer);
        answer4 = question4_answer.getText().toString().toLowerCase();
        if (answer4.equals("billion")) {
            answer4_score = 1;
        } else {
            answer4_score = 0;
        }
        ...
        //------------------------------------------------------------------------------------------
        Boolean answer5;
        question5_choice2 = (RadioButton) this.findViewById(R.id.questionGen5_choice2);
        ...
        //------------------------------------------------------------------------------------------
        String answer6;
        question6_answer = (EditText) this.findViewById(R.id.questionGen6_answer);
        answer6 = question6_answer.getText().toString().toLowerCase();
        if (answer6.equals("9") || answer6.equals("nelson mandela")) {
            answer6_score = 1;
        } else {
            answer6_score = 0;
        }
        ...
        question7_choice1 = (CheckBox) this.findViewById(R.id.questionGen7_choice1);
        question7_choice2 = (CheckBox) this.findViewById(R.id.questionGen7_choice2);
        question7_choice3 = (CheckBox) this.findViewById(R.id.questionGen7_choice3);
        question7_choice4 = (CheckBox) this.findViewById(R.id.questionGen7_choice4);
        ...
        //------------------------------------------------------------------------------------------
        String answer8;
        question8_answer = (EditText) this.findViewById(R.id.questionGen8_answer);
        answer8 = question8_answer.getText().toString().toLowerCase();
        if (answer8.equals("yellow")) {
            answer8_score = 1;
        } else {
            answer8_score = 0;
        }
        ...
        //------------------------------------------------------------------------------------------
        Boolean answer9;
        question9_choice1 = (RadioButton) this.findViewById(R.id.questionGen9_choice2);
        ...
        //------------------------------------------------------------------------------------------
        String answer10;
        question10_answer = (EditText) this.findViewById(R.id.questionGen10_answer);
        answer10 = question10_answer.getText().toString().toLowerCase();
        if (answer10.equals("63")) {
            answer10_score = 1;
        } else {
            answer10_score = 0;
        }
